...
system("cp -f /Users/sio/ovo/OVO/list/SingleDish/H2O-Sources-The-latest-Observed-list-IRK.txt /Volumes/sioHD/ovo/SingleDish/");
system("cp -f /Users/sio/ovo/OVO/list/SingleDish/history/*-history.txt /Volumes/sioHD/ovo/SingleDish/history/irk/H2O/");
